    ...
    return (
        <div className="welcome-page">
            ...
            <div className="WP-paragraphs">
                <p>
                    I'm thrilled to introduce you to my TodoList application, built with the MERN tech stack.
                    <br/>
                    <b>M.E.R.N.</b> stands for MongoDB, Express.js, React.js, and Node.js.
                    Each component of this stack plays a crucial role in ensuring a smooth and efficient user
                    experience.
                </p>
                <p>
                    <b>MongoDB</b> is a powerful NoSQL database that allows for flexible and scalable data storage.
                ...
                <p>
                    <b>Express.js</b> is a minimalist web framework for Node.js that simplifies the process of building
                    web
                ...
                <p>
                    <b>Node.js</b> is a server-side JavaScript runtime environment that enables the execution of
                    JavaScript
